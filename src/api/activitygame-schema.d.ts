        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["GetGameDetailsResponseApiResponse"];
                    };
                };
                /** @description Not Found */
                404: {
...
export interface components {
    schemas: {
        ...
        GetGameDetailsResponse: {
            /** Format: uuid */
            id: string;
            host: components["schemas"]["PlayerResponse"];
            /** Format: int32 */
            timer: number;
            /** Format: int32 */
            maxScore: number;
        ...
        GetGameDetailsResponseApiResponse: {
            success?: boolean;
            message?: string | null;
            errorCode?: components["schemas"]["ErrorCode"];
            data?: components["schemas"]["GetGameDetailsResponse"];
        };
        /** @enum {string} */
